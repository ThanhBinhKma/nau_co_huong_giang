...
class Common
{
	...
	* Check status
	*/
    public static function checkStatusProduct($status)
    {
        $html = '';
        switch ($status) {
            case '0':
                $html .= '<span class="label-danger status-label">Hết hàng</span>';
                break;
            case '1':
                $html .= '<span class="label-success status-label">Còn hàng</span>';
                break;
            default:
                # code...
                break;
    ...
    public static function checkHaveMoney($status)
    {
        $html = '';
        switch ($status) {
            case '0':
                $html .= '<span class="label-danger status-label">Chưa thanh toán</span>';
                break;
            case '1':
                $html .= '<span class="label-success status-label">Đã thanh toán</span>';
                break;
            default:
                # code...
                break;
    ...
    public static function checkStatussBill($status)
    {
        $html = '';
        switch ($status) {
            case '0':
                $html .= '<span class="label-danger status-label">Bị hủy</span>';
                break;
            case '1':
            ...
            case '2':
                $html .= '<span class="label-primary status-label">Đang giao</span>';
                break;

            case '3':
                $html .= '<span class="label-primary status-label">Chuẩn bị giao</span>';
                break;
            default:
                # code...
                break;
