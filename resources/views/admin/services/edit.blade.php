...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="{{ route('system_admin.services.update', ['id' => $service->id]) }}">
            {{ csrf_field() }}
            @if ($errors->all())
                            ...
                            <div class="tab-pane active show" id="tab_detail">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Nhập tên trang" data-counter="120" name="title"
                                        type="text" id="title" value="{{ $service->name }}">
                ...
                <div class="col-md-3 right-sidebar">
                    ...
                    <div class="widget meta-boxes">
                        ...
                        <div class="widget-body">
                            <div class="image-box">
                                @if ($service->image)
                                    <input id="thumbnail" type="hidden" name="thumbnail" value="{{ $service->image }}"
                                        class="image-data">
                                    <div class="preview-image-wrapper ">
                                        <img id="holder" class="preview_image" src="{{ $service->image }}" type="text"
