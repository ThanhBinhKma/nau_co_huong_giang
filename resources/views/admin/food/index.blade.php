                ...
                <div class="box">
                    <div class="box-header with-border">
                        <div class="pull-right">
                            ...
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                <a href="{{ route('system_admin.foods.create') }}" class="btn btn-sm btn-success"
                                    title="New">
                                    ...
                                    @foreach ($foods as $food)
                                        <tr>
                                           ...
                                           <td class="text-center">
                                            ...
                                            <td> {{ \Carbon\Carbon::parse($food->created_at)->format('d/m/Y H:i:s') }}
                                            </td>
                                            <td>
                                                <a href="{{ route('system_admin.foods.edit', ['id' => $food->id]) }}"
                    ...
                    <div class="box-footer clearfix">
                        <div class="col-md-5">
                            Hiển thị trang <b>{{ $foods->currentPage() }}</b> / <b>{{ $foods->lastPage() }}</b>
                        </div>
                        <div class="col-md-7">
                            {{ $foods->appends([
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.deleteDialog').on('click', function() {
                ...
                destroy(post_id, '{{ route('system_admin.foods.destroy') }}',
                    '{{ route('system_admin.foods.index') }}', "Bạn muốn xóa bài đăng này!");
            });
        });
        $('.grid-batch-0').on('click', function() {
            destroyAll('{{ route('system_admin.foods.destroyAll') }}',
                '{{ route('system_admin.foods.index') }}', "Bạn muốn xóa các bài đăng đã chọn?");
        });
