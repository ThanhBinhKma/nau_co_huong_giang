...
@section('content')
    <section class="content">
        ...
        <form method="POST" action="{{route('system_admin.bills.store')}}">
            {{ csrf_field() }}
            @if ($errors->all())
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active show" id="tab_detail">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="quantity" class="form-control" data-counter="120" placeholder="Nhập số lượng" value="{{ old('quantity') }}">
                                </div>

                                <div class="form-group">
                                    <label for="link" class="control-label required">Địa chỉ</label>
                                    <input type="text" name="address" class="form-control" data-counter="120" placeholder="Nhập địa chỉ" value="{{ old('address') }}">
                                </div>
                                <div class="form-group">
                                    <label for="link" class="control-label ">Số điện thoại</label>
                                    <input type="text" name="phone" class="form-control" data-counter="120" placeholder="Nhập số điện thoại" value="{{ old('phone') }}">
                                </div>
                                <div class="form-group">
                                    <label for="link" class="control-label ">Link Facebook</label>
                                    <input type="text" name="facebook" class="form-control" data-counter="120" placeholder="Nhập link facebook" value="{{ old('facebook') }}">
                                </div>
                        ...
                        <div class="widget-body">
                            <div class="ui-select-wrapper">
                                <select class="form-control ui-select ui-select" id="status" name="status">
                                    ...
                                    <option value="3">Chuẩn bị giao</option>
                                </select>
