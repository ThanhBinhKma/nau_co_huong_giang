                ...
                <div class="box">
                    <div class="box-header with-border">
                        <div class="pull-right">
                            ...
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                <a href="{{route('system_admin.products.create')}}" class="btn btn-sm btn-success"
                                   title="New">
                ...
                <div class="portlet-title">
                  ...
                  <button class="btn btn-primary btn-show-table-options">
                                ...
                                @foreach($products as $product)
                                    <tr>
                                        ...
                                        <td style="width: 100px;">
                                            <img src="{{asset('images/' . $product->link_image)}}" alt="" style="max-width: 100px;max-height: 100px;min-width: 100px;min-height: 100px;object-fit: cover">
                                        </td>

                                        <td> {{ \Carbon\Carbon::parse($product->date)->format('d/m/Y')}}</td>
                                        <td> {{ $product->quantity}} </td>
                                        <td> {{ $product->quantity_main}} </td>
                                        <td>{{  number_format($product->price, 0, '', ',')}} VNĐ</td>
                                        <td>{{  number_format($product->total_money, 0, '', ',')}} VNĐ</td>
                                        <td> {!! \App\Helpers\Common::checkStatusProduct($product->status) !!} </td>
                                        <td>
                                            <a href="{{route('system_admin.products.edit',['id'=>$product->id])}}"
                    ...
                    <div class="box-footer clearfix">
                        <div class="col-md-5">
                            Hiển thị trang <b>{{ $products->currentPage() }}</b> / <b>{{ $products->lastPage() }}</b>
                        </div>
                        <div class="col-md-7">
                            {{
                              $products->appends([
