                ...
                <div class="box">
                    <div class="box-header with-border">
                        <div class="pull-right">
                            ...
                            <div class="btn-group pull-right" style="margin-right: 10px">
                                <a href="{{ route('system_admin.food_type.create') }}" class="btn btn-sm btn-success"
                                    title="New">
                                ...
                                @if (count($menus) > 0)
                                    @foreach ($menus as $menu)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('system_admin.food_type.edit', ['id' => $menu->id]) }}"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('.deleteDialog').on('click', function() {
                ...
                destroy(post_id, '{{ route('system_admin.food_type.destroy') }}',
                    '{{ route('system_admin.food_type.index') }}', "Bạn muốn xóa bài đăng này!");
            });
        });
        $('.grid-batch-0').on('click', function() {
            destroyAll('{{ route('system_admin.food_type.destroyAll') }}',
                '{{ route('system_admin.food_type.index') }}', "Bạn muốn xóa các bài đăng đã chọn?");
        });
